              ...
              methods: {
                ...
                changeFavorites: function(){
                  for (var i = 0; i< this.ingredient_ids.length; i++){
                    ...
                    if(this.favoriteIngredients.length === Math.trunc(this.ingredient_ids.length/3)){/* delar upp antalet ingredienser i 3 och trunkerar till det närmaste värdet*/
                      let count = 1;
                      let burger = {
                        ...
                        this.favoriteIngredients = []; /*nollställer favortieIngredients arrayen*/
